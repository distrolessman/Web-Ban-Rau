                ...
                <div class="cart-view-area">
                    <div class="cart-view-table">
                                ...
                                <table class="table">
                                    ...
                                    <c:forEach items="${order.items}" var="item">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath}/view/client/product-detail?id=${item.product.id}"><img
                                                        src="${item.product.image_link}"
                                                        alt="img${item.product.name }"></a></td>
                                            <td><a class="aa-cart-title"
                                                   href="${pageContext.request.contextPath}/view/client/product-detail?id=${item.product.id}">${item.product.name }</a>
                                            </td>
                                            <td><fmt:formatNumber value="${item.product.price}" type="number"/> VNĐ</td>
                                            <td><input class="aa-cart-quantity" type="number" name="${item.product.id}"
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><fmt:formatNumber value="${sumprice}" type="number"/> VNĐ</strong></td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="cart-view-total">
                            ...
                            <a href="${pageContext.request.contextPath}/view/client/checkout" class="aa-cart-view-btn">Thanh
                                toán</a>
                        </div>
                    </div>
                </div>
