                ...
                <div class="aa-product-catg-content">
                    <div class="aa-product-catg-body">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <p style="margin-bottom:30px;">Kết quả tìm kiếm cho từ khóa: <strong>${param.s}</strong>
                                </p>
                            </c:otherwise>
                        </c:choose>
                                        ...
                                        <figcaption>
                                            ...
                                            <c:choose>
                                                <c:when test="${product.discount == 0}">
                                                    <span class="aa-product-price"><fmt:formatNumber value="${product.price}" type="number"/> VNĐ</span><span
                                                        class="aa-product-price"></span>
                                                </c:when>
                                                <c:otherwise>
                                                    <c:set var="discountPrice1" value="${product.price * (1.0 - product.discount/100.0)}"></c:set>
                                                    <span class="aa-product-price"><fmt:formatNumber value="${discountPrice1}" type="number"/> VNĐ</span>
                ...
                <aside class="aa-sidebar">
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <ul class="aa-catg-nav">
                            <c:forEach items="${catelist}" var="cate">
                                <li>
                                    <a href="${pageContext.request.contextPath}/view/client/product-id?id=${cate.id}">${cate.name}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
                    ...
                    <div class="aa-sidebar-widget">
                        ...
                        <div class="aa-recently-views">
                            <ul>
                                <c:forEach items="${listProducts}" var="product" end="2">
                                    <li>
                                        <a href="${pageContext.request.contextPath}/view/client/product-detail?id=${product.id}"
                                           class="aa-cartbox-img"><img alt="img" src="${product.image_link}"></a>
                                        <div class="aa-cartbox-info">
                                            ...
                                            <c:choose>
                                                <c:when test="${product.discount == 0}">
                                                    <p><fmt:formatNumber value="${product.price}" type="number"/> VNĐ</p>
                                                </c:when>
                                                <c:otherwise>
                                                    <c:set var="discountPrice1" value="${product.price * (1.0 - product.discount/100.0)}"></c:set>
                                                    <span class="aa-product-price"><fmt:formatNumber value="${discountPrice1}" type="number"/> VNĐ</span>
