                    ...
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/new/edit" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="input-1" placeholder="ID"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-10" placeholder="Địa chỉ hình ảnh"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="input-5" value="${boardnew.created}"
                                       name="new-created">
                            </div>
