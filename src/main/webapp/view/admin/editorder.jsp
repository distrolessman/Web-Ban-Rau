                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/order/edit">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" name="order-name"
                                       value="${order.user_name}">
                            </div>
                            <div class="form-group">
                                <label for="input-1">Email</label>
                                <input type="text" class="form-control" id="input-1" name="order-mail"
                                       value="${order.user_mail}">
                            </div>
                            <div class="form-group">
                                <label for="input-1">Số điện thoại</label>
                                <input type="text" class="form-control" id="input-1" name="order-phone"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-1" name="order-amount"
                                       value="${order.amount}">
                            </div>
                            <div class="form-group">
                                <label for="input-2">Phương thức thanh toán</label>
                                <div>
                                    <select class="form-control valid" id="input-6" name="order-payment" required
                                            aria-invalid="false">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-control valid" id="input-6" name="order-status" required
                                            aria-invalid="false">
                            ...
                            <div class="form-footer">
                                <button class="btn btn-danger"><a
                                        href="${pageContext.request.contextPath}/admin/order/list">Hủy</a></button>
