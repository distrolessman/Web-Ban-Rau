                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="${pageContext.request.contextPath}/admin/product/add">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="the-date" placeholder="Ngày đăng"
                                       name="product-day">
                            </div>
                            <div class="form-group">
...
<%--                                       name="product-image">--%>
                            ...
                            <div class="form-footer">
                                ...
                                <button type="button" id="request-url-upload" onclick="requestUploadURL()" class="btn btn-success"><i class="fa fa-check-square-o"></i> Thêm
                                </button>
                            </div>
                        </form>
                    </div>
